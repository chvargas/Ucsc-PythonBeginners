...
while looping == True:
    ...
    if type(numberEntered) == int:
        numbersListIntegers.append(numberEntered)
    elif type(numberEntered) == float:
            numbersListFloats.append(numberEntered)
    return 
    
    if numberEntered == '':
        looping = False
        
        print numbersListIntegers
        print numberListFLoats
